...
if ( !class_exists('PluginUpdateChecker_crf_2', false) ):
 ...
 * @access public
 */
class PluginUpdateChecker_crf_2 {
...
PucFactory::addVersion('PluginUpdateChecker', 'PluginUpdateChecker_crf_2', '2.2');
...
if ( !class_exists('PluginUpdateChecker', false) ) {
	class PluginUpdateChecker extends PluginUpdateChecker_crf_2 { }
}
