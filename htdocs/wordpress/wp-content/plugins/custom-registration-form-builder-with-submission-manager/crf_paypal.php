...
$send_box = get_option('crf_test_mode','no');
$crf_paypal_email = get_option('crf_paypal_email');
$crf_currency = get_option('crf_currency');
$crf_paypal_page_style = get_option('crf_paypal_page_style');
...
switch($action){
	...
	echo '<div id="crf-form">';
		echo "<div class='info-text'>Transaction Cancelle</br>";
		echo '</div></div>';
	break;
