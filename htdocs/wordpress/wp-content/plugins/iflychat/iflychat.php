...
function iflychat_init() {
  ...
  $my_settings['renderImageInline'] = (iflychat_get_option('iflychat_allow_render_images') == '1')?'1':'2';
	if(iflychat_check_chat_admin()) {
		...
		$my_settings['text_manage_rooms'] = __('Dashboard', 'iflychat');
    ...
    wp_enqueue_script( 'iflychat-ajax', '//cdn.iflychat.com/integration/wordpress/js/iflychat-init.min.js', array('jquery'));
    ...
    //if((isset($_GET['updated']) && $_GET['updated'] == 'true') || (isset($_GET['settings-updated']) && $_GET['settings-updated'] == 'true')) {
      if(iflychat_get_option('iflychat_api_key') != " ") {
        $data = array(
          ...
          'deny_write_access' =>  (iflychat_get_option('iflychat_allow_send_message') == "1")?'0':'1',
      	);
